...
//Removes user from local storage when logout is pressed
const logout = (e) => {
...
const HomeNav = (props) => {
  ...
  //Sets user's avatar and username to be displayed in homenav
  useEffect(() => {
    if (user) {
      const url = "http://83.212.77.220:3100/api/user/" + Base64.decode(user.e);
