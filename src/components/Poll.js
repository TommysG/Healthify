...
export const Poll = ({ question, ans1, ans2, ans3, votes }) => {
	let totalVotes = 0;
						...
						<tbody>
							<tr>
								<td>
									<div className="progress-div">
										<ProgressBar
											now={calculateBar(totalVotes, votes[0])}
											label={ans1}
											id="one"
										/>
									</div>
							...
							<tr>
								<td>
									<div className="progress-div">
										<ProgressBar
											now={calculateBar(totalVotes, votes[1])}
											label={ans2}
											id="two"
										></ProgressBar>
									</div>
							...
							<tr>
								<td>
									<div className="progress-div">
										<ProgressBar
											now={calculateBar(totalVotes, votes[2])}
											label={ans3}
											id="three"
										></ProgressBar>
									</div>
