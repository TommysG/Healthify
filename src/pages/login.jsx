...
export class login extends Component {
  ...
  //If user is logged this page is skipped
  componentDidMount() {
  ...
  //Authenticates user and displayes proper message
  logIn = (event) => {
  ...
  // Custom spinner displayed while the validation is hapenning
  loginLoading = () => {
  ...
  //Handles redirect = true. Redirects user to home
  renderRedirect = () => {
  ...
  //Validates user's input. If username/email isn't valid or blank displays proper message.
  validateLogin = (event) => {
  ...
  //Gets the text that user has typed.
  getInputText = (event) => {
  ...
  //Allows user to log in with his facebook account
  ...
  render() {
    ...
    let smallGlButton = (
      <GoogleLogin
        ...
        onSuccess={this.responseGoogle}
        onFailure={this.responseGoogle}
        className="btn-floating btn-google-small"
        cookiePolicy={"single_host_origin"}
        buttonText={""}
      />
    );
