...
export class settings extends Component {
  ...
  myPosts = () => {
    const user = JSON.parse(localStorage.getItem(Base64.encode("user")));
    let url1 =
      "http://83.212.77.220:3100/api/userPosts/" + Base64.decode(user.e);
    let url2 =
      "http://83.212.77.220:3100/api/userPostsVotes/" + Base64.decode(user.e);
  ...
  saveChanges = () => {
    ...
    if (this.state.newPassword && this.state.oldPassword) {
      fetch("http://83.212.77.220:3100/api/changePassword", {
        method: "POST",
        headers: {
          "content-type": "application/json",
          accept: "application/json",
  ...
  deleteAccount = () => {
    fetch("http://83.212.77.220:3100/api/user/" + this.state.email, {
      method: "DELETE",
      headers: {
        "content-type": "application/json",
        accept: "application/json",
